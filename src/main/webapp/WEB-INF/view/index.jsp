...
<%-- <nav class="navbar navbar-default">
    ...
    <div class="collapse navbar-collapse" style="float:none;text-align:right;"  id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right" >
        <li><a href="#"><img width="40px" height="40px" src="/resource/images/j_0003[1].gif"/> </a></li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
          		韩梅梅 <span class="caret"></span></a>
		...
		<div class="row">
			...
			<div class="col-md-2" style="minheight:200px" >
				...
				<div class="panel panel-info">
					...
					<div class="panel-body">
					<c:forEach items="${newArticle }" var="article" varStatus="count">
						${count.count }<a>${article.title }</a>
						<br>
					</c:forEach>
					</div>
				</div>
