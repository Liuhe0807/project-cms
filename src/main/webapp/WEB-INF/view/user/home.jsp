...
<body style="background:url(/pic/111.jpg)">

<!-- 导航条 -->
<nav class="navbar navbar-default" style="background:#010000" >
...
<nav class="navbar navbar-default navbar-fixed-bottom" style="background:#021000">
